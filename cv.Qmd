...
author:
  ...
  contacts:
    - icon: fa envelope
      text: luisd@syeop.co.za
      url: "mailto:luisd@syeop.co.za"
    - icon: assets/icon/bi-house-fill.svg
      text: www.growinconsultation.com
      url: https://www.growinconsultation.com
    - icon: fa brands orcid
      text: 0000-0000-0000-0000
      url: https://orcid.org/0000-0000-0000-0000
    - icon: fa brands github
      text: GitHub
      url: https://github.com/luisdza
    - icon: fa brands sessionize
      text: sessionize
      url: https://sessionize.com/luis-de-sousa

    - icon: fa brands linkedin
      text: LinkedIn
      url: https://linkedin.com/in/luisdza
    - icon: fa brands x-twitter
      text: twitter
      url: https://twitter.com/luis_de_sousa   
