...
tribble(
  ...
  "Data Modeller Architect", "Financial Services", "2024-2025", "As a senior engineer, I conducted a data landscape assessment to align the data product capability with best practices from DAMA-DMBOK and Enterprise Data Management (EDM) frameworks. I played a key role in debugging and optimising the 'Next Best Action' as-a-service capability.",
