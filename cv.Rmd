...
tribble(
  ...
  "Data Engineering and Analytics Expertise", "Architecting End-to-End Data Systems", list("Proficient in designing and implementing robust data solutions, including data warehousing, integration, and analytics.", "Skilled in using SQL, R, Python, Microsoft Data Platform, Azure DevOps, MySQL, Google BigQuery, Databricks, Github Actions and FiveTran.", "Experienced in financial data consolidation, market analysis, and forecasting."),
