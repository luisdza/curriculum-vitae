...
tribble(
  ...
  "AI and Data Engineer", "Education", "2024", "As a senior data consultant, I designed and implemented data solutions on Azure Synapse Analytics and Microsoft Fabric. Built a Retrieval Augmented Generation (RAG) database AI solution using Azure OpenAI and Python to enhance student support through data-driven insights.",
